...
import com.passbase.auth.Authentication;
import com.passbase.auth.HttpBasicAuth;
import com.passbase.auth.ApiKeyAuth;
import com.passbase.auth.OAuth;

public class ApiClient {

    private String basePath = "https://api.passbase.com/verification/v1";
    ...
    public ApiClient() {
        ...
        setUserAgent("passbase/java@0.0.1");

        // Setup authentications (key: authentication name, value: authentication).
        authentications = new HashMap<String, Authentication>();
        authentications.put("IdentityAccessToken", new OAuth());
        authentications.put("PublishableApiKey", new ApiKeyAuth("header", "X-API-KEY"));
        authentications.put("SecretApiKey", new ApiKeyAuth("header", "X-API-KEY"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.passbase.com/verification/v1
