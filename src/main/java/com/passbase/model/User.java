...
public class User {
  ...
  **/
  @Schema(example = "[{\"step\":\"email\",\"resource_types\":[\"EMAIL\"]},{\"step\":\"liveness_check\",\"resource_types\":[\"FACE_VIDEO\"]},{\"step\":\"country\",\"resource_types\":[\"de\",\"us\",\"vn\",\"zn\"]},{\"step\":\"identity_document_check\",\"resource_types\":[\"PASSPORT\",\"DRIVERS_LICENSE\"]},{\"step\":\"insurance_card_scan\",\"resource_types\":[\"HEALTH_INSURANCE_CARD\"]}]", description = "List of the steps through which the user must go through to complete their verification ")
